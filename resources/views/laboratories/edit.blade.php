                ...
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a ><i class="fe fe-life-buoy mr-1"></i>&nbsp Laboratoriya ma'lumotlarini o'zgartirish
                            </a>
                        </li>
                    </ol>
                </div>
                                ...
                                <div class="panel panel-primary">
                                    <div class="tab_wrapper page-tab">
                                        <ul class="tab_list">
                                            ...
                                            <li class="active">
                                                <a href="{!! url('/laboratories/list/edit/'.$editid )!!}">
                                                    <span class="visible-xs"></span>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <label class="form-label"
                                                           for="first-name">Laboratoriya nomi <label
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                               for="owner_name">Akkredatsiya guvohnomasi <label
                                                                class="text-danger">*</label>
                                                        </label>
                                                        <input type="text" required="required" name="certificate"
                                                               class="form-control" value="{{ $company->certificate }}">
                                                    </div>
                                                </div>
                                                <div id="tin-container" class="col-md-6 legal-fields">
                                                    <div class="form-group">
                                                        <label class="form-label">Laboratoriya kodi<label class="text-danger">*</label></label>
                                                        <input class="form-control" type="number" name="kod"  required="required" value="{{ $company->kod }}"
                                                        />
                                                    </div>
                                                </div>
