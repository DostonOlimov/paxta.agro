                ...
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <i class="fe fe-life-buoy mr-1"></i>&nbsp Laboratoriya qo'shish
                        </li>
                    </ol>
                </div>
                                        ...
                                        <form action="{{ url('/laboratories/store') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                               for="first-name">Sinov laboratoriyasining nomi <label
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                               for="owner_name">Laboratoriyaning akkreditatsiya guvohnomasi <label
                                                                class="text-danger">*</label>
                                                        </label>
                                                        <input type="text" required="required" name="certifikate"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                                <div id="tin-container" class="col-md-6 legal-fields">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number" name="kod" max="99999999" required="required"/>
                                                    </div>
                                                </div>
