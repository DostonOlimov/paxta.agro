                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{!! url('sifat-sertificates2/client-update') !!}" enctype="multipart/form-data"
                                        ...
                                        <select id="client" class="form-control owner_search" name="client" required>
                                            @if (!empty($clients))
                                                @foreach ($clients as $select)
                                                    <option @if($select->id == $data->client_id) selected @endif value="{{ $select->id }}">{{ $select->name }}
                                                    </option>
