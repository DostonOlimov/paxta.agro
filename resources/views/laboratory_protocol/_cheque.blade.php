    ...
    <div>
        ...
        <table class="table table-border " style="border: 1px solid black ;text-align: center;font-size: 18px;">
            ...
            <tr>
                ...
                <td>{{ round($item->dalolatnoma->laboratory_result->humidity,1) }}</td>
            ...
            <tr>
                ...
                <td>
                    @if (5.0 < ($final_result[0]->dalolatnoma->laboratory_result->humidity) && ($final_result[0]->dalolatnoma->laboratory_result->humidity) < 8.5) muvofiq @else nomuvofiq @endif </td>
                <td>
