    ...
    <div>
        <h2 style="text-align: center; margin-top: 10px; font-size: 28px"><b>
            ...
            nazorat qilish Inspektsiyasi qoshidagi<br> --}}
                ...
                <span style="font-size: 20px">Davlat reestri raqami {{ $test->test_program->application->decision->laboratory->certificate . ' ' . $test->test_program->application->decision->laboratory->address }}</span>
            </b>
        </h2>
        <div style="display: flex; justify-content: end; padding-right: 12%; font-size: 20px">
            <p>Laboratoriya kodi <span style="border-bottom: 1px solid black; padding: 0 4px;">{{ $test->test_program->application->decision->laboratory->kod }}</span></p>
        </div>
    </div>
    ...
    <div>
        <div style="display: flex; justify-content: space-between; font-weight: 500;font-size: 22px; height: fit-content; margin-bottom: 15px">
            ...
            <div class="documentDate" style="display: flex; column-gap: 4px;">
                <span><<<span style="display: inline-block; border-bottom: 1px solid black; padding: 0px 24px; height: fit-content;">{{ $day1 }}</span>>></span>
        ...
        <div style="height: 26px; display: flex; font-weight: 500;font-size: 18px;">
            <p></p>
            <p style="margin-left: 47%;">(ariza beruvchining nomi, kodi)</p>
        </div>
        ...
        <div style="display: flex; font-weight: 500;font-size: 20px; height: 35px; align-items: flex-start;">
            ...
            <div class="documentDate" style="display: flex; column-gap: 4px;">
                <span><<<span style="display: inline-block; border-bottom: 1px solid black; padding: 0px 24px; height: 26px;">{{ $day2 }}</span>>></span>
                <span style="border-bottom: 1px solid black; padding: 0px 28px; height: 26px;">{{ $month2 }}</span>
                <span style="border-bottom: 1px solid black; padding: 0px 8px 0px 12px; height: 26px;">{{ $year2 }}y</span>
            </div>
        ...
        <div style="display: flex; font-weight: 500;font-size: 20px;">
            <p>
                ...
                <span style="height: 26px; border-bottom: solid 1px black">{{ '№' . optional($test->laboratory_final_results)->number }}</span>
