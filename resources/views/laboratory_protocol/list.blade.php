                                    ...
                                    @foreach($apps as $app)
                                        <tr>
                                            ...
                                            <td>{{ optional($app->test_program)->application->crops->name->name }}</td>
                                                <td>
                                                    @if (isset($app->measurement_mistake) && isset($app->laboratory_result) && isset($app->result) && !isset($app->laboratory_final_results))
                                                    ...
                                                    @elseif (isset($app->measurement_mistake) && isset($app->laboratory_result) && isset($app->result) && isset($app->laboratory_final_results))
