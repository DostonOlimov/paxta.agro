            ...
            <div>
                <div class="dropdown">
                    ...
                    <div class="my-dropdown-content">
                        <a href="#" onclick="changeLanguage('uz')"><img src="/img/flags/uzbekistan.png"
                                class="flag">O'zbek</a>
                        <a href="#" onclick="changeLanguage('krill')"><img src="/img/flags/uzbekistan.png"
                                class="flag">Ўзбек</a>
                        <a href="#" onclick="changeLanguage('en')"><img src="/img/flags/united-kingdom.png"
                                class="flag">English</a>
                        <a href="#" onclick="changeLanguage('ru')"><img src="/img/flags/russia.png"
