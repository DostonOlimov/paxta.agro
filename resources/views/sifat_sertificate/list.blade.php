							...
							<table class="table table-striped table-bordered nowrap display" style="margin-top:20px;" >
								<thead>
									<tr>
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('/sifat-sertificates/list', ['sort_by' => 'party_number', 'sort_order' => ($sort_by === 'party_number' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('/sifat-sertificates/list', ['sort_by' => 'date', 'sort_order' => ($sort_by === 'date' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
										...
										<th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('/sifat-sertificates/list', ['sort_by' => 'organization', 'sort_order' => ($sort_by === 'organization' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
										...
										<th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('/sifat-sertificates/list', ['sort_by' => 'amount', 'sort_order' => ($sort_by === 'amount' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                                {{trans('app.amount')}}
                                                @if($sort_by === 'amount')
                                                    @if($sort_order === 'asc')
                                                        <i class="fa fa-arrow-up"></i>
                                ...
                                @endphp
									...
									<tr>
										...
										<td>
                                            <a href="{!! url('/sifat-sertificates/view/'.$app->id) !!}"><button type="button" class="btn btn-round btn-info">{{ trans('app.View')}}</button></a>
                                            <a href="{!! url('/sifat-sertificates/edit/'.$app->id) !!}" ><button type="button" class="btn btn-round btn-success">{{ trans('app.Edit')}}</button></a>
										</td>
									</tr>
								@endforeach
								</tbody>
