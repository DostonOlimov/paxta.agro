...
@section('content')
    ...
    <div id="invoice-cheque" class="py-4 col-12 invoice-cheque ">
        ...
        <h1  class="header__intro" style="font-weight: bold;">Nomuvofiqlik bayonnomasi</h1>
        ...
        <h3 class="main__intro" style="color: red"> To‘da yuqoridagi ko‘rsatkichlari bo‘yicha O’z DSt 596 standartining 4.1, 4.2 bandlariga nomuvofiq.</h3>
        <div style="width: 100%;padding-top: 50px; display: flex; justify-content: space-between;">
            ...
            <div style="width: 30%; text-align: center; display: inline-block;">
                <img src="data:image/png;base64,{{ $qrCode }}" style="height: 120px;" alt="QR Code">
            </div>
        </div>
    </div>
