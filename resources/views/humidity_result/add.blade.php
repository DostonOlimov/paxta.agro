            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <i class="fe fe-life-buoy mr-1"></i>&nbsp Namlik bo'yicha dalolatnomani natijasini qo'shish
                    </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="invoice-form" method="post" action="{!! url('humidity_result/store') !!}" enctype="multipart/form-data"
                                ...
                                <div class="row" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group has-feedback {{ $errors->has('m0') ? ' has-error' : '' }}">
                                            ...
                                            <input type="number" step="0.01"  class="form-control" value="{{ old('m0')}}"  name="m0" required>
                                            @if ($errors->has('m0'))
                                                <span class="help-block">
                                        ...
                                        <div class="col-md-6 form-group has-feedback {{ $errors->has('mk0') ? ' has-error' : '' }}">
                                            <label for="number" class="form-label ">Na'muna1<label class="text-danger">*</label></label>
                                            <input type="number" step="0.01"  class="form-control"  value="{{ old('mk0')}}"  name="mk0" required>
                                            @if ($errors->has('mk0'))
                                                <span class="help-block">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group has-feedback {{ $errors->has('m1') ? ' has-error' : '' }}">
                                            ...
                                            <input type="number" step="0.01"  class="form-control" value="{{ old('m1') }}"  name="m1" required>
                                            @if ($errors->has('m1'))
                                                <span class="help-block">
                                        ...
                                        <div class="col-md-6 form-group has-feedback {{ $errors->has('mk1') ? ' has-error' : '' }}">
                                            <label for="number" class="form-label ">Na'muna2<label class="text-danger">*</label></label>
                                            <input type="number" step="0.01" class="form-control" value="{{ old('mk1') }}"  name="mk1" required>
                                            @if ($errors->has('mk1'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-md-6 form-group has-feedback {{ $errors->has('kalibrovka') ? ' has-error' : '' }}">
                                        ...
                                        <input type="number" step="0.0001" class="form-control" value="{{ old('kalibrovka') }}"  name="kalibrovka" required>
