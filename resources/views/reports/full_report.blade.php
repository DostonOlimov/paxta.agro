                                ...
                                <table id="examples1" class="table table-striped table-bordered " style="margin-top:20px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="8" style="text-align: center">
                                                {{ trans('app.Sifat nazorati natijalari') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="background-color: #90aec6 !important;">
                                            ...
                                            <td>
                                                <form class="d-flex">
                                                    <input type="text" name="" class="search-input form-control"
                                                        placeholder="DALOLATNOMA RAQAMI">
                                                </form>
                                            </td>
                                            ...
                                            <td>
                                                <form class="d-flex">
                                                    <input type="text" name="" class="search-input form-control"
                                                        placeholder="TOʼDA (PARTIYA) RAQAMI">
                                                </form>
                                            </td>
                                            <td></td>
                                            <td></td>
                                            ...
                                            @foreach ($results as $result)
                                                <tr>
                                                    @if (isset($result->test_program->application))
                                                        ...
                                                        <td><a
                                                                href="{!! url('/application/view/' . optional($result->test_program->application)->id) !!}">{{ optional($result->test_program->application)->date }}</a>
                                                        </td>
                                                        ...
                                                        <td>{{ optional($result->test_program->application->prepared)->name }}
                                                        </td>
                                                        ...
                                                        <td>{{ optional($result->test_program->application->crops)->year }}
                                                        </td>

                                                        <td> {{ $result->count }}</td>
                                                        <td> {{ optional($result)->amount ? $result->amount . ' kg' : '' }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            @if ($result->certificate)
                                                                <a
                                                                    href="{{ route('attachment.download', ['id' => $result->certificate->attachment->id]) }}"><button
                                                                        type="button"
                                                                        class="btn btn-round btn-info">{{ trans('app.Sertifikat fayli') }}</button></a>
                                                            @endif
                                                        </td>
                                                    @endif
