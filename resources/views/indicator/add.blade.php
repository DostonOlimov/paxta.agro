                                        ...
                                        <form action="{{ url('/indicator/store') }}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group has-feedback">
                                                    <label class="form-label" for="name">Sifat ko'rsatkich nomi <label class="text-danger">*</label></label>
                                                    <div class="">
                                                        <textarea id="data" required name="name" class="form-control" maxlength="500" >{{ old('name')}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 form-group has-feedback">
                                                    <label class="form-label" for="nd_name">Sifat ko'rsatkichning me'yoriy hujjatlari <label class="text-danger">*</label></label>
                                                    <div class="">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label"
                                                               for="first-name">Ekin turi <label
