        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form action="{{ url('/application/my-file-local-store') }}" method="post"
                        ...
                        <div class="col-md-6 pb-4">
                            ...
                            <label class="form-label">Aprobatsiya dalolatnomasini yuklang</label>
                            <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                   required name="a_dalolatnoma"
                        ...
                        <div class="col-md-6 pb-4">
                            <div class="form-control-file">
                            <label class="form-label">Aprobatsiya xulosasini yuklang</label>
                            <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                   required name="a_xulosa"
                                   accept="application/pdf"
                            />
                            </div>
                        </div>
                        <div class="col-md-6 pb-4">
                            <label class="form-label">Dorilash xulosasini yuklang</label>
                            <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                   required name="d_xulosa"
                                   accept="application/pdf"
                            />
                        </div>
                        <div class="col-md-6 pb-4">
                            <label class="form-label">Markirovkani yuklang</label>
                            <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
