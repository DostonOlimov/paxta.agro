        ...
        <div class="section">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form action="{{ url('/application/my-file-foreign-store') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 pb-4">
                                <div class="form-control-file">
                                    <label class="form-label">Karantin ruxsatnomasi (IKR)</label>
                                    <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                           required name="karantin"
                            ...
                            <div class="col-md-6 pb-4">
                                <div class="form-control-file">
                                    <label class="form-label">Mahsulotga tegishli xorijiy fitosanitar sertifikati</label>
                                    <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                           required name="fitosanitar"
                                           accept="application/pdf"
                                    />
                                </div>
                            </div>
                            <div class="col-md-6 pb-4">
                                <label class="form-label">Muvofiqlik sertifikati</label>
                                <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                       required name="m_sertificat"
                                       accept="application/pdf"
                                />
                            </div>
                            <div class="col-md-6 pb-4">
                                <label class="form-label">Markirovka</label>
                                <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                       required name="markirovka"
                                       accept="application/pdf"
                                />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 pb-4">
                                <div class="form-control-file">
                                    <label class="form-label">Hisob-faktura (invoys)</label>
                                    <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                            name="invoys"
                                           accept="application/pdf"
                                    />
                            ...
                            <div class="col-md-6 pb-4">
                                <label class="form-label">Yuk xati</label>
                                <input class="form-control" type="file" placeholder="Asos hujjatni yuklang..."
                                        name="yuk_xati"
                                       accept="application/pdf"
                                />
