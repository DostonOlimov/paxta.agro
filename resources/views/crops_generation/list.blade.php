                ...
                <div class="page-header">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <i class="fe fe-life-buoy mr-1"></i>&nbsp{{trans('message.Sinflar ro\'yxatii')}}
                        </li>
                    </ol>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table table-striped table-bordered nowrap" style="margin-top:20px; width:100%;">
                                        <thead>
                                        <tr>
                                            <th>{{trans('message.Sinf kodi')}}</th>
                                            <th>{{trans('message.Sinf nomi')}}</th>
                                        ...
                                        @foreach($types as $type)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{!! url ('/crops_generation/list/edit/'.$type->id) !!}"> <button type="button" class="btn btn-round btn-success">{{ trans('app.Edit')}}</button></a>
