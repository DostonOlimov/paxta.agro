							...
							<div class="row">
								...
								<div class="col-md-3 form-group has-feedback">
									...
									<div class=" gender">
										<label class="custom-control custom-radio">
											<input type="radio" class="custom-control-input"  name="gender" value="6" checked required checked>
											<span class="custom-control-label">{{ trans('app.Male')}} </span>
										</label>
										 <label class="custom-control custom-radio">
											<input type="radio"  class="custom-control-input" name="gender" value="8" required>
								...
								<div class="col-md-6 form-group has-feedback">
									...
									<select class="form-control" name="branch_id" required>
										...
										<option value="{{ \App\Models\User::BRANCH_MAIN }}">{{ trans('app.Branch Main') }}</option>
