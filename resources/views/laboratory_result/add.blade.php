            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <i class="fe fe-life-buoy mr-1"></i>Laboratoriya natijalarini kiritish
                    </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="invoice-form" method="post" action="{!! url('laboratory_results/store') !!}" enctype="multipart/form-data"
