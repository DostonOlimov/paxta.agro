            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <i class="fe fe-life-buoy mr-1"></i>&nbsp Maxsus Xulosalar Ro'yxati
                    </li>
                </ol>
            </div>
                                ...
                                <table class="table table-striped table-bordered nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('product_conclusion.list', ['sort_by' => 'number', 'sort_order' => ($sort_by === 'number' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('product_conclusion.list', ['sort_by' => 'party_number', 'sort_order' => ($sort_by === 'party_number' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('product_conclusion.list', ['sort_by' => 'date', 'sort_order' => ($sort_by === 'date' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                        ...
                                        <th class="border-bottom-0 border-top-0">
                                            <a href="{{ route('product_conclusion.list', ['sort_by' => 'organization', 'sort_order' => ($sort_by === 'organization' && $sort_order === 'asc') ? 'desc' : 'asc']) }}">
                                    ...
                                    @foreach($apps as $app)
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;">
                                                ...
                                                <a href="{!! url('product-conclusion/refresh' , $app) !!}">
                                            ...
                                            <td>{{ optional($app->test_program)->application->crops->name->name }}</td>
                                                <td>
                                                    @if (!isset($app->laboratory_final_results))
                                                        <a href="{!! url('product-conclusion/add' ,$app) !!}"> <button type="button"
                                                            class="btn btn-round btn-warning "><i
                                                                class="fa fa-plus-circle"></i>
                                                            {{ trans('app.Qo\'shish') }}</button></a>
                                                    @else
                                                        @if($app->laboratory_final_results->status != 1)
                                                                <a href="{!! url('product-conclusion/view' , $app) !!}"><button type="button"
