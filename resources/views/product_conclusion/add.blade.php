            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <i class="fe fe-life-buoy mr-1"></i>&nbsp Maxsus Xulosani qo'shish
                    </li>
                </ol>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="invoice-form" method="post" action="{!! url('product-conclusion/store', $dalolatnoma) !!}" enctype="multipart/form-data"
                                  data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                <div class="row" >

                                    <div class="col-md-4 form-group has-feedback {{ $errors->has('number') ? ' has-error' : '' }}">
                                        <label for="number" class="form-label certificate">{{trans('app.Xulosa raqami')}}<label class="text-danger">*</label></label>

                                        <input type="number" class="form-control" maxlength="10" value="{{ old('number')}}"  name="number" required>
                                        @if ($errors->has('number'))
                                            <span class="help-block">
											 <strong>{{trans("app.Xulosa raqami noto'g'ri shaklda kiritilgan")}}</strong>
										   </span>
                                        @endif
                                    </div>
                                    <div class="col-md-4 form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                                        <label class="form-label certificate">{{trans("app.Xulosa sanasi")}} <label class="text-danger">*</label></label>
                                    ...
                                    <div class="col-md-6 form-group">
                                     ...
                                     <div class="col-md-6 form-group">
                                        <label for="order_number" class="form-label certificate">Buyurtma raqami<label class="text-danger">*</label></label>
                                        <input type="number" class="form-control" name="order_number" value="{{ old('order_number') }}" required>
                                    </div>
                                    <div class="col-md-6 form-group">
                                    ...
                                    <input type="hidden" name="klassiyor_id" value="{{ optional(optional($clampData)->klassiyor)->id }}">
