                            ...
                            <div class="row">
                                <div id="tin-container" class="form__organization__field legal-fields">
                                    <div class="form-group">
                                        <label class="form-label">{{trans('app.Buyurtmachi korxona yoki tashkilot  STIRi')}}<label class="text-danger">*</label></label>
                                ...
                                <div class="form__organization__field">
                                    <div class="form-group">
                                        <label class="form-label" for="owner_name">{{trans('app.Raxbarning ismi-sharifi')}} <label class="text-danger">*</label>
                                        </label>
                                ...
                                <div
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" placeholder="{{trans('app.Enter Mobile No')}}"
                                               id="phone_number" class="form-control"
                                               data-pattern-mismatch="Telefon raqamni kiriting" required="required"
                                ...
                                <div class="form__organization__field">
                                    <div class="form-group overflow-hidden">
                                        ...
                                        <select class="w-100 form-control state_of_country custom-select" name="state_id"
                                            ...
                                            @if (count($states))
                                                <option value="" disabled selected>{{trans('app.Viloyat tanlang')}}</option>
                                            @endif
                                            @if (!empty($states))
