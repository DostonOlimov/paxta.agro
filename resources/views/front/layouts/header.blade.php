        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="hero__search__phone">
                    @if (auth()->user())
                        <div class="hero__search__main__phone">
                    <div class="hero__search__phone__text ">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="form-control" type="submit"> <h5 class="text-danger"> <i class="fa fa-sign-out "></i>Chiqish</h5></button>
                            </form>
                    </div>
                        </div>
                        @else
                        <a class="hero__search__main__phone" href="{{ url('/login') }}">
